...
{
    MIR_CORE_ASSERT(entity.HasComponent<IDComponent>());
    ...
    if (entity.HasComponent<CircleCollider2DComponent>()) {
        ...
        out << YAML::Key << "RestitutionThreshold" << YAML::Value
            << cc2dComponent.RestitutionThreshold;
...
{
    // Not implemented
    MIR_CORE_ASSERT(false, "Not implemented");
}
...
bool SceneSerializer::Deserialize(const std::string& filepath)
{
    ...
    if (entities) {
        for (auto entity : entities) {
            ...
            MIR_CORE_TRACE("Deserialized entity with ID = {0}, name = {1}", uuid, name);
            ...
            if (spriteRendererComponent) {
                ...
                if (spriteRendererComponent["TexturePath"]) {
                    src.Texture =
                        Texture2D::Create(spriteRendererComponent["TexturePath"].as<std::string>());
                }
