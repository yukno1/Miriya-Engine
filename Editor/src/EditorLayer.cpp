...
void EditorLayer::OnAttach()
{
    ...
    Miriya::FramebufferSpecification fbSpec;
    fbSpec.Width  = 1280;
    fbSpec.Height = 720;
    m_Framebuffer = Miriya::Framebuffer::Create(fbSpec);
}
...
void EditorLayer::OnUpdate(Miriya::Timestep ts)
{
    MIR_PROFILE_FUNCTION();
...
void EditorLayer::OnEvent(Miriya::Event& e)
{
