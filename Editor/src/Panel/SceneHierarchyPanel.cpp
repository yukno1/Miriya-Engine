                            ...
                            float columnWidth = 100.0f)
{
    ...
    float lineHeight =
        ImGui::GetFrameHeight();   // ImGui::GetFontSize() + GImGui->Style.FramePadding.y * 2.0f;
...
void SceneHierarchyPanel::DrawComponents(Entity entity)
{
    ...
    if (entity.HasComponent<CameraComponent>()) {
        if (ImGui::TreeNodeEx(
                (void*)typeid(CameraComponent).hash_code(), treeNodeFlags, "Camera")) {
    ...
    if (entity.HasComponent<SpriteRendererComponent>()) {
        ...
        bool open = ImGui::TreeNodeEx(
            (void*)typeid(SpriteRendererComponent).hash_code(), treeNodeFlags, "Sprite Renderer");
